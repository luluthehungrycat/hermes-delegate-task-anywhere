...
def test_cli_fallback_uses_safe_argv_and_propagates_depth() -> None:
    captured = {}
    ...
    assert captured["argv"] == [
        ...
        "--model", "target-model", "-t", "web,browser,terminal,file,vision,image_gen,tts,skills,todo,memory,context_engine,session_search,clarify,code_execution,cronjob,homeassistant,spotify,computer_use", "-Q", "-q", '{"tasks": [{"goal": "inspect"}], "role": "leaf", "delegation_depth": 1}',
    ]
